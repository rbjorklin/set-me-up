...
set.writebackup = true -- Good safety feature in-case of vim failure.
set.swapfile = true -- I just lost work because this was disabled. My system froze and everything in the buffer was permanently lost.
